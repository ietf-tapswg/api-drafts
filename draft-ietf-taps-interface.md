...
connections that are not entangled with it. Any state generated by this
...
Note that this does not guarantee no leakage of information, since things like
RTT estimates, etc., might not be fully isolated.

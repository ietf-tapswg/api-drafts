...
Specify a Remote Endpoint using a hostname and service name (since `WithProtocol` is not used, it is up to the Transport Services system to choose which sets of protocols to use, e.g., TLS/TCP or QUIC):

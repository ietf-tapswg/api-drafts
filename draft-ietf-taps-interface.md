...
later control of the required minimum receiver checksum coverage (see {{rcksum}}).
...
resulting Connection cannot use IPv4, because temporary addresses do not exist in
IPv4.

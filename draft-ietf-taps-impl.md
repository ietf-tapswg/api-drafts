...
This document structures the candidates for racing as a tree as terminological convention; it is not necessary for an implementation to do so, but it does ease the illustration of how racing works. 
